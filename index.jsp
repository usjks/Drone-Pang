...
<body>
	<div id="outline">
		...
		<div id="login">
			<a id="joinMember" href="join.jsp"><input type="button"
				value="회원가입" class="btn-primary btn-lg"
				style="font-weight: bold; width: 100px; font-size: 15px; float: right;"></a>
			<a id="loginMember" href="login.jsp"><input type="button"
				value="로그인" class="btn-primary  btn-lg"
				style="font-weight: bold; width: 90px; font-size: 15px; float: right; margin-right: 20px;"></a>
		</div>
		...
		<div class="Content">
			<div class="nume1" style="margin-left: 0px;">
				<div class="nheader">화장품</div>
				<a href="selectorganic.do?p_number=${cosmetic_item.p_number }&p_category=${cosmetic_item.p_category}">
					<dl>
						<!-- 목록 -->
						<dt>
							<!--용어  -->
			...
			<div class="nume1">
				...
				<a href="selectorganic.do?p_number=${perfume_item.p_number }&p_category=${perfume_item.p_category}">
					<dl>
						<!-- 목록 -->
						<dt>
							<!--용어  -->
			...
			<div class="nume1" style="margin-right: 0px;">
				<div class="nheader">미용기구</div>
				<a href="selectorganic.do?p_number=${beauty_item.p_number }&p_category=${beauty_item.p_category}">
					<dl>
						<!-- 목록 -->
						<dt>
							<!--용어  -->
