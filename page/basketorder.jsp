...
<body>
	...
	<form id="form" name="f" action="basketordercomplete.do" method="post">
		...
		<div id="con">
			...
			<div id="nav">
				...
				<div id="order">
					<h2>구매 상품</h2>
					<!-- foreach문 시작 -->
					<c:forEach var="ordervo" items="${basketorderList}">

						<div id="order_div">

							<div id="order_img">
								<img id="img1" src="${ordervo.p_photourl}"> <input
									type="text" id="p_photourl" style="display: none;"
							...
							<div id="inputvalue">
								<p>
									상품 이름: <input name="p_name" type="text"
										value="${ordervo.p_name}" readonly="readonly"> <input
										name="basketnum" type="text" value="${ordervo.basketnum}"
				...
				<div id="nav_cash">
					...
					<div style="margin: 15px 0px;">
						<p>
							총액 : <input id="allpay_price" name="allpay_price" type="text"
								value="${allpay_price}" readonly="readonly">
						</p>

						<p>총결제금액 : ${allpay_price}원</p>
						...
						$("#check_module")
								.click(
										function() {
											...
											var productAmount = $("input[name='p_name']").length;

											if (productAmount >= 2) {
												/* 장바구니 상품이 여러개인 경우 */
												productName = $("input[name='p_name']")[0].value + ' 외 '+ (productAmount-1) +' 개';
